...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `services` (feedback_email, booking_email, transportation_type, promotions_link)
            VALUES ('$feedback_email', '$booking_email', '$transportation_type', '$promotions_link')";
